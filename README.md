...
* [shellfirm](https://github.com/kaplanelad/shellfirm) ⭐ 933 | 🐛 3 | 🌐 Rust | 📅 2026-05-15 - It is a handy utility to help avoid running dangerous commands with an extra approval step. You will immediately get a small prompt challenge that will double verify your action when risky patterns are detected.
